...
function draw() {
  ...
  text("Cash = +50", 25,50);
  text("Diamonds = +100", 25,75);
  text("Jwelery = +150", 25,100);
  text("Sword = GAME OVER", 25,125);
  }
...
function createCash() {
  if (World.frameCount % 200 == 0) {
   ...
   var cash = createSprite(width+20,height-70,10,10); 
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(width+20,height-70,10,10); 
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(width+20,height-70,10,10); 
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(width+20,height-70,10,10); 
